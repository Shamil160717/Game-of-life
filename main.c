...
int main(int argc, const char *argv[])
{
    ...
    // char windowTitle[] = "Conway's Game of Life, Seed: ";
    ...
    pDisplay = SDL_CreateWindow("Game of Life", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, myArrayDeclaredLength, myArrayDeclaredLength, SDL_WINDOW_SHOWN);

    if (pDisplay == NULL)
    {
        printf("There was a problem setting the display");
        exit(-1);
    }
